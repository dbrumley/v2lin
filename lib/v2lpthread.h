...
#define TRUE  !FALSE
#endif
#define V2PT_TICK v2pt_Tick()	/* milliseconds per v2pthread scheduler tick */
/*
...
typedef struct task_s
{
    ...
    /* for task events */
    pthread_mutex_t tevent_lock;
    pthread_cond_t  t_eventable;
    struct task_s  *event_first_susp;
    unsigned long   signaled_events;
